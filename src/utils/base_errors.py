...
class BaseErrors:
    ...
    # api permissions
    you_dont_have_manage_users_permission = _('You Do not Have Permission For Manage Users')
    you_dont_have_manage_psp_permission = _('You Do not Have Permission For Manage PSP')
    you_dont_have_manage_machine_permission = _('You Do not Have Permission For Manage Machines')

    # user api`s
    you_cant_remove_user_you_not_user_creator = _('You Cant Delete User, Because You Are Not User Creator.')
    you_cant_edit_user_you_not_user_creator = _('You Cant Edit User, Because You Are Not User Creator.')
